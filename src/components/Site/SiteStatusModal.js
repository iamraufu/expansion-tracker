...
const SiteStatusModal = ({ data, handleModalSwitch, investors, fetchData }) => {
    ...
    const [remarks, setRemarks] = useState(
        selectedStatusDetails[0]?.remarks
            ? selectedStatusDetails[0].remarks
            : ""
    );
    ...
    const documentTypes = [
        ...
        {
            label: "photograph of franchisee",
            value: "photograph of franchisee",
        },
        ...
        {
            label: "no objection certificate from partner / other owner of the premises, if there is several owner of the premises",
            value: "no objection certificate from partner / other owner of the premises, if there is several owner of the premises",
        },
        {
        ...
        {
            label: "land tax/holding tax copy",
            value: "land tax/holding tax copy",
        },
        {
        ...
        {
            label: "bank transaction identity (bank a/c, a/c name & photocopy of cheque)",
            value: "bank transaction identity (bank a/c, a/c name & photocopy of cheque)",
        },
        {
        ...
        {
            label: "undated signature cheque",
            value: "undated signature cheque",
        },
    ];
    ...
    const handleStatusChange = (value) => {
        ...
        if (newStatusOption.level < currentStatusOption.level) {
            ...
            newStatusOption.value === "franchise agreement" &&
            currentStatusOption.value === "docs collected"
        ) {
            setNewStatus(value);
        ...
        const selectedStatusEquipments =
            selectedStatusDetails[0]?.equipmentOptions;
                        ...
                        <div className="mt-4 flex flex-col">
                            <div className="mt-4 flex flex-col">
                                ...
                                <p className="capitalize w-full">
                                    {data.landlords[0].customId} -{" "}
                                    {data.landlords[0].name}
                                </p>
                            </div>
                        </div>
                    </>
                ...
                <div>
                    {newStatus === "RMIA validation" &&
                        !data.feasibilityDoneByOperations && (
                            <p className="my-4 px-3 bg-red-100 py-2 border border-red-600 rounded-md font-medium">
                                ⚠️ Feasibility by Operations Must be checked
                                first!
                            </p>
                        )}
                </div>
