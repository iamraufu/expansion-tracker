  ...
  return (
    ...
    <div className="details-tab mt-4">
      ...
      <div className="details-section flex flex-col my-4 gap-4">
        ...
        <div className="flex gap-2 w-full">
          <h1 className="w-32 font-medium">Inv. Budget:</h1>
          <p className="capitalize">{data?.investmentBudget}</p>
        </div>
        <div className="flex gap-2 w-full">
          <h1 className="w-32 font-medium">Possible Inv. Date:</h1>
          <p className="capitalize">{new Date(data?.possibleInvestmentDate).toLocaleDateString()}</p>
        </div>
        <div className="flex gap-2 w-full">
