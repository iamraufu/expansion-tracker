  ...
  return (
    ...
    !togglefeasibiltyForm ?  
      <section className="padding-x">
       ...
       <div onClick={() => setTogglefeasibiltyForm(false)} className="w-full bg-blue-500 text-white py-2 px-4 rounded text-center my-4">Go Back</div>
       <button type="submit" className="w-full bg-green-500 text-white py-2 px-4 rounded">Submit</button>
     </form>
    }
    </>
  );
