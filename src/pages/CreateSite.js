                            ...
                            <div className="fixed inset-0 flex items-center justify-center z-50 p-3">
                                <div className=" bg-white p-6 rounded shadow-lg max-w-md w-full">
                                    ...
                                    <div className="my-2 flex gap-2">
                                        ...
                                        <p>
                                            {benchMarkSite.avgMonthlyProfit.toFixed(
                                                2
                                            )}
                                        </p>
                                    </div>
                                    ...
                                    <div
                                        id="alert-border-4"
                                        className="flex items-center p-3 shadow-sm my-4 text-yellow-800 border-t-4 border-yellow-300 bg-yellow-50"
                                        role="alert"
                                    >
                                        <svg
                                        ...
                                        <div className="ms-3 text-sm font-medium">
                                            Your site does not meet the standard feasibility
